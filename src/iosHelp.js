...
export function getHelp(state) {
  const helps = {
    ...
    privileged: [
      ...
      ["erase startup-config", "Erase NVRAM filesystem"],
      ["exit", "Exit from the EXEC"],
      ["logout", "Exit from the EXEC"],
      ["ping", "Send echo messages"],
    ...
    "config-if": [
      ...
      ["encapsulation dot1q", "Set 802.1Q VLAN tagging"],
      ["exit", "Exit from interface configuration mode"],
      ["ip access-group", "Specify access control for packets"],
      ["ip address", "Set the IP address of an interface"],
      ["ip arp inspection trust", "Configure trust state for DAI"],
      ["ip dhcp snooping trust", "Configure DHCP Snooping trust"],
      ["ip helper-address", "Specify a destination address for UDP broadcasts"],
      ["ip nat inside|outside", "NAT interface designation"],
      ["ip ospf", "OSPF interface commands"],
      ["ipv6 address", "Set the IPv6 address of an interface"],
      ...
      ["speed", "Set speed on an interface"],
    ...
    "config-subif": [
      ["description", "Interface specific description"],
      ["encapsulation dot1q", "Set 802.1Q VLAN tagging"],
      ["exit", "Exit from subinterface configuration mode"],
      ["ip address", "Set the IP address of a subinterface"],
      ["ip helper-address", "Specify a destination for UDP broadcasts"],
      ["ip nat inside|outside", "NAT interface designation"],
      ["ip ospf", "OSPF interface commands"],
      ["ipv6 address", "Set the IPv6 address"],
      ["no", "Negate a command"],
      ["shutdown", "Shutdown the selected subinterface"],
    ],
    "config-line": [
